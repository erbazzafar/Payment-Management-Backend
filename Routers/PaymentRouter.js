...
const { createPayment, getAllPayments, getUserPayments, updatePayment, getPaymentSummary, getUserSummary, ifscValidation, accountNumberValidation } = require('../Controllers/PaymentController')

const paymentRouter = express.Router()

paymentRouter.post('/accountValidate', accountNumberValidation)
